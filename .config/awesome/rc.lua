...
beautiful.init("/home/paulw/.config/awesome/theme/theme.lua")
...
tags = {}
for s = 1, screen.count() do
	tags[s] = awful.tag({ " 1 ", " 2 ", " 3 ", " 4 ", " 5 ", " 6 ", " 7 ", " 8 ", " 9 " }, s, mylayouts[1])
end
-- }}}
...
for s = 1, screen.count() do
	...
	mylayoutbox[s]:buttons(
		awful.util.table.join(
			awful.button({ }, 1, function () awful.layout.inc(mylayouts, 1) end),
			awful.button({ }, 3, function () awful.layout.inc(mylayouts, -1) end),
			awful.button({ }, 4, function () awful.layout.inc(mylayouts, 1) end),
			awful.button({ }, 5, function () awful.layout.inc(mylayouts, -1) end)
		)
	)
...
globalkeys = awful.util.table.join(
	-- Layout
	awful.key({ modkey }, "space",          function () awful.layout.inc(mylayouts,  1) end),
	awful.key({ modkey, "Shift" }, "space", function () awful.layout.inc(mylayouts, -1) end),
